...
class  tx_categories_modfunc extends t3lib_SCbase {
	 ...
	 */
	 function main()    {
		...
		if($this->id) {
			...
			$this->content .= '<br /><br />';
			$this->content .= t3lib_BEfunc::cshItem('_MOD_txcategoriesMain_txcategoriesFunc', 'aboutfuncmodule', $this->doc->backPath,'|'.$LANG->getLL('about_func_module', 1));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/categories/mod_func/class.tx_categories_modfunc.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/categories/mod_func/class.tx_categories_modfunc.php']);
}
